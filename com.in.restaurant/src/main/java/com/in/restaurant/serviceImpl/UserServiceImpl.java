...
public class UserServiceImpl implements UserService {
    ...
    public ResponseEntity<String> signUp(Map<String, String> requestMap) {
        // validate request map-- in requestMap we need some values like email id,
        // contact number
        // this much of data need to present otherwise request is invalid
        ...
        try {
            if (validateSignUpMap(requestMap)) {
                ...
                // we can't able to find with this email
                if (Objects.isNull(user)) {
                    // if we can't find user with this email id
    ...
    private boolean validateSignUpMap(Map<String, String> requestMap) {
        ...
        // this is validator method
        // this much values provided from ui--- status and role we need to signup
